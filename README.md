...
| `tiles[].active` | boolean | `true` | When set to `false` (uncheck **Active** in the editor), the tile is **hidden from the main grid** and only appears inside the aggregator modal for its phase. |
